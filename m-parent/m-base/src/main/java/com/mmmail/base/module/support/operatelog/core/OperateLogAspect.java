package com.mmmail.base.module.support.operatelog.core;
...
import com.mmmail.base.module.support.operatelog.OperateLogDao;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(com.mmmail.base.module.support.operatelog.annotation.OperateLog) || @annotation(com.mmmail.base.module.support.operatelog.annotation.OperateLog)";
