package com.mmmail.base.module.support.codegenerator.service.variable.backend.domain;
...
import com.mmmail.base.module.support.codegenerator.domain.model.CodeField;
import com.mmmail.base.module.support.codegenerator.domain.model.CodeInsertAndUpdate;
import com.mmmail.base.module.support.codegenerator.domain.model.CodeInsertAndUpdateField;
    ...
    public ImmutablePair<List<String>, List<Map<String, Object>>> getPackageListAndFields(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        for (CodeInsertAndUpdateField field : fields) {
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getEnumName())) {
                packageList.add("import com.mmmail.base.common.swagger.SchemaEnum;");
                packageList.add("import com.mmmail.base.common.validator.enumeration.CheckEnum;");
            ...
            if (SmartStringUtil.isNotEmpty(codeField.getDict())) {
                ...
                packageList.add("import com.mmmail.base.common.json.deserializer.DictDataDeserializer;");
            }
            ...
            if (CodeFrontComponentEnum.FILE_UPLOAD.equalsValue(field.getFrontComponent())) {
                ...
                packageList.add("import com.fasterxml.jackson.databind.annotation.JsonDeserialize;");
                packageList.add("import com.mmmail.base.common.json.deserializer.FileKeyVoDeserializer;");
            }
