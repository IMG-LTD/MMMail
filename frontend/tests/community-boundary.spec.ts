...
describe('community boundary helpers', () => {
  it('groups modules by maturity with stable counts', () => {
    ...
    expect(countCommunityModulesBySurface('LABS')).toBe(11)
  ...
  it('keeps hosted-only and self-hosted boundary registries non-empty', () => {
    ...
    expect(COMMUNITY_BOUNDARY_DOC_PATHS).toContain('docs/release/community-v1-v1.4-mainline-roadmap.md')
    expect(COMMUNITY_BOUNDARY_DOC_PATHS).toContain('docs/release/community-v1-v1.4.0-release-notes.md')
...
describe('suite release boundary panel', () => {
  it('renders boundary sections and canonical docs', () => {
    ...
    expect(wrapper.text()).toContain('docs/release/community-v1-v1.4-mainline-roadmap.md')
    expect(wrapper.text()).toContain('docs/release/community-v1-v1.4.0-release-notes.md')
