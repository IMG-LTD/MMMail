...
const requiredOverlayContracts = [
  {
    action: "activateMailComposeSecurity",
    id: "mail-compose-security",
    selector: ".mail-trust-panel",
  },
  {
    action: "openCalendarEventDrawer",
    id: "calendar-event-drawer",
    selector: ".calendar-event-drawer",
  },
  ...
  {
    action: "clickSheetsProtectedRange",
    id: "sheets-protected-range",
    selector: ".sheets-protected-range-modal",
  },
  {
    action: "activatePassSecretActions",
    id: "pass-secret-actions",
    selector: ".pass-rotate-confirmation",
  },
  {
    action: "openPassShareSettings",
    id: "pass-secure-link-settings",
    selector: ".pass-share-settings-modal",
  },
...
test("v2.1 browser visual QA runner exposes expanded coverage registry", async () => {
  const [packageJsonRaw, qaScript, browserHarness, scenarioSource, reportSource] =
    await Promise.all([
  ...
  assert.match(
    browserHarness,
    /openCalendarEventDrawer:\s*clickSelectorExpression\('\.calendar-event-trigger'\)/,
  );
