...
test('v2.1 labs and collaboration runtime boundaries use shared clients', async () => {
  const [labsApi, collaborationApi, labsOverviewView, labsModuleView, collaborationView] = await Promise.all([
  ...
  for (const endpoint of ['/api/v2/labs/modules', '/api/v2/collaboration/projects', '/api/v2/collaboration/tasks', '/api/v2/collaboration/activity']) {
