...
export const ROUTE_SCENARIOS = [
  ...
  appRoute(
    ...
    "日历",
    "/calendar",
    [".calendar-page", ".calendar-filter-sidebar", ".calendar-board"],
    ALL_VIEWPORTS,
  ),
  {
  ...
  appRoute(
    ...
    "文档",
    "/docs/demo-document",
    [".docs-editor", ".docs-editor__canvas"],
    DESKTOP_ONLY,
  ),
  appRoute(
    "sheets-workspace",
    "Sheets和labs",
    "/sheets",
    [".sheets-workspace", ".data-table", ".sheets-preview"],
    ALL_VIEWPORTS,
  ),
  appRoute(
    "sheets-editor",
    "Sheets和labs",
    "/sheets/demo-sheet",
    [".sheets-editor", ".sheets-editor__grid"],
    DESKTOP_ONLY,
  ),
  ...
  appRoute(
    ...
    "Pass",
    "/pass/monitor",
    [".pass-risk-monitor-panel", ".pass-risk-detail"],
    DESKTOP_ONLY,
  ),
  appRoute(
  ...
  appRoute(
    ...
    "Notifications",
    "/notifications",
    [".notifications-layout", ".data-table"],
    ALL_VIEWPORTS,
  ),
...
export const PUBLIC_BOUNDARY_SCENARIOS = [
  ...
  publicRoute("boundary", "/boundary", [
    ".public-surface-frame",
    ".boundary-page",
    ".boundary-matrix",
  ]),
  publicRoute("product-access-blocked", "/product-access-blocked", [
    ".public-surface-frame",
    ".blocked-page",
    ".premium-gate",
  ]),
...
export const OVERLAY_SCENARIOS = [
  overlay("command-palette", "首页", "/workspace", "clickCommandPalette", [
    '.command-palette[role="dialog"]',
  ]),
  overlay("quick-create", "首页", "/workspace", "clickQuickCreate", [
    '.mm-modal[role="dialog"][aria-modal="true"]',
    ".quick-create-modal",
  ]),
  overlay("theme-drawer", "首页", "/workspace", "clickThemeDrawer", [
    '.mm-drawer[role="dialog"][aria-modal="true"]',
    ".theme-drawer",
  ]),
  overlay("mail-compose", "邮件", "/mail/compose", "none", [
    ".mail-compose",
    ".mail-compose-panel",
    ".mail-trust-panel",
  ]),
  overlay("mail-compose-security", "邮件", "/mail/compose", "activateMailComposeSecurity", [
    ".mail-compose-panel",
    ".mail-trust-panel",
  ...
  overlay("mail-thread-workbench", "邮件", "/mail/inbox", "none", [
    ".mail-folder-rail",
    ".mail-message-list",
    ".mail-thread-reader",
    ".mail-attachment-strip",
  ]),
  overlay("calendar-event-drawer", "日历", "/calendar", "openCalendarEventDrawer", [
    ".calendar-event-drawer",
    ".calendar-conflict-panel",
    ".calendar-resource-state",
  ]),
  overlay("drive-share-panel", "云盘", "/drive", "clickDriveSharePanel", [
    ".drive-share-panel",
    ".drive-share-panel__title",
    ".drive-share-panel__members",
    ".drive-share-panel__public-link",
    ".drive-share-panel__revoke",
    ".drive-share-panel__retry",
  ]),
  overlay("docs-share-panel", "文档", "/docs/demo-document", "clickDocsSharePanel", [
    ".docs-share-panel",
    ".docs-share-panel__invite-input",
    ".docs-share-panel__role-select",
    ".docs-share-panel__link-access",
    ".docs-share-panel__collaborators",
    ".docs-share-panel__error",
    ".docs-share-panel__retry",
  ]),
  overlay(
    "sheets-protected-range",
    "Sheets和labs",
    "/sheets/demo-sheet",
    "clickSheetsProtectedRange",
    [
      ...
      ".sheets-protected-range-modal__retry",
    ],
  ),
  overlay("pass-secret-actions", "Pass", "/pass", "activatePassSecretActions", [
    ".pass-item-detail",
    ".pass-secret-reveal",
  ...
  overlay("pass-secure-link-settings", "Pass", "/pass/secure-links", "openPassShareSettings", [
    ".pass-share-settings-modal",
    ".pass-action-error",
    ".pass-action-retry",
  ]),
  overlay("pass-risk-detail", "Pass", "/pass/monitor", "openPassRiskDetail", [
    ".pass-risk-monitor-panel",
    ".pass-risk-detail",
    ".pass-action-retry",
  ]),
  overlay("settings-delete-confirmation", "Setting", "/settings", "clickDeleteAccount", [
    '.mm-modal[role="dialog"][aria-modal="true"]',
