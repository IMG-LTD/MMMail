...
export const shellNavGroups: NavGroup[] = [
  {
    ...
    items: [
      { key: 'workspace', label: lt('工作台', '工作台', 'Workspace'), path: '/suite', canonicalPath: '/workspace', fallbackPath: '/suite', tone: 'workspace', matchPrefixes: ['/workspace', '/suite'] }
    ]
  },
  {
    title: lt('产品', '產品', 'Products'),
    items: [
      { key: 'mail', label: lt('邮件', '郵件', 'Mail'), path: '/inbox', canonicalPath: '/mail', fallbackPath: '/inbox', tone: 'mail', matchPrefixes: ['/mail', ...mailRoutePrefixes] },
      { key: 'calendar', label: lt('日历', '日曆', 'Calendar'), path: '/calendar', canonicalPath: '/calendar', fallbackPath: '/calendar', tone: 'calendar', matchPrefixes: ['/calendar'] },
      { key: 'drive', label: lt('云盘', '雲端硬碟', 'Drive'), path: '/drive', canonicalPath: '/drive', fallbackPath: '/drive', tone: 'drive', matchPrefixes: ['/drive'] },
      { key: 'docs', label: lt('文档', '文件', 'Docs'), path: '/docs', canonicalPath: '/docs', fallbackPath: '/docs', tone: 'docs', matchPrefixes: ['/docs'], maturity: 'beta' },
      { key: 'sheets', label: lt('表格', '試算表', 'Sheets'), path: '/sheets', canonicalPath: '/sheets', fallbackPath: '/sheets', tone: 'sheets', matchPrefixes: ['/sheets'], maturity: 'beta' },
      { key: 'pass', label: lt('密码库', '密碼庫', 'Pass'), path: '/pass', canonicalPath: '/pass', fallbackPath: '/pass', tone: 'pass', matchPrefixes: ['/pass', '/pass-monitor'] }
    ]
  },
  {
    ...
    items: [
      { key: 'collaboration', label: lt('协作', '協作', 'Collaboration'), path: '/collaboration', canonicalPath: '/collaboration', fallbackPath: '/collaboration', tone: 'collaboration', matchPrefixes: ['/collaboration'], maturity: 'preview' },
      { key: 'command-center', label: lt('指挥中心', '指揮中心', 'Command Center'), path: '/command-center', canonicalPath: '/command-center', fallbackPath: '/command-center', tone: 'command', matchPrefixes: ['/command-center'], maturity: 'preview' },
      { key: 'notifications', label: lt('通知', '通知', 'Notifications'), path: '/notifications', canonicalPath: '/notifications', fallbackPath: '/notifications', tone: 'notifications', matchPrefixes: ['/notifications'], maturity: 'preview' }
    ]
  },
  {
    title: lt('治理', '治理', 'Governance'),
    items: [
      { key: 'admin', label: lt('管理后台', '管理後台', 'Admin'), path: '/organizations', canonicalPath: '/admin', fallbackPath: '/organizations', tone: 'admin', matchPrefixes: ['/admin', '/organizations', '/business', '/security'] },
      { key: 'settings', label: lt('设置', '設定', 'Settings'), path: '/settings', canonicalPath: '/settings', fallbackPath: '/settings', tone: 'settings', matchPrefixes: ['/settings'] },
      { key: 'labs', label: lt('Labs', 'Labs', 'Labs'), path: '/labs', canonicalPath: '/labs', fallbackPath: '/labs', tone: 'labs', matchPrefixes: ['/labs'], maturity: 'preview' }
    ]
  }
]
...
export const mobilePrimaryTabs: MobilePrimaryTab[] = [
  { key: 'workspace', label: lt('工作台', '工作台', 'Home'), hint: lt('总览', '總覽', 'Overview'), path: '/suite', matchPrefixes: ['/workspace', '/suite'] },
  { key: 'mail', label: lt('邮件', '郵件', 'Mail'), hint: lt('收件箱', '收件匣', 'Inbox'), path: '/inbox', matchPrefixes: ['/mail', ...mailRoutePrefixes] },
  ...
  { key: 'drive', label: lt('云盘', '雲端硬碟', 'Drive'), hint: lt('文件', '檔案', 'Files'), path: '/drive', matchPrefixes: ['/drive'] },
  {
    ...
    path: '/suite',
    matchPrefixes: ['/docs', '/sheets', '/pass', '/collaboration', '/command-center', '/notifications', '/admin', '/organizations', '/business', '/security', '/settings', '/labs']
  }
]
