export function hasRouteEntityChanged(
  previousRouteEntityId: string | null | undefined,
  nextRouteEntityId: string | null | undefined,
) {
  return String(previousRouteEntityId || "") !== String(nextRouteEntityId || "");
}

export function createRouteEntityNavigationReset(
  nextRouteEntityId: string | null | undefined,
...
export function isCurrentRouteEntity(
...
export function isRouteEntityEditingLocked(
  routeEntityId: string,
  loadedEntityId: string | null | undefined,
...
export function canSubmitRouteEntitySave(
  ...
  return (
    !isRouteEntityEditingLocked(routeEntityId, loadedEntityId, entityLoading) &&
    !saveLoading &&
    canEdit &&
    hasChanges
  );
