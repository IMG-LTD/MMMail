...
export const themePresets: ThemePreset[] = [
  {
    ...
    description: lt(
      "MMMail 默认平衡配色，适合中性界面与邮件优先场景。",
      "MMMail 預設平衡配色，適合中性介面與郵件優先場景。",
      "Default MMMail balance for neutral surfaces and mail-first accents.",
    ),
    accent: "#4f6bed",
  ...
  },
  {
    ...
    description: lt(
      "更克制的钢灰强调色，适合高密度运营工作区。",
      "更克制的鋼灰強調色，適合高密度營運工作區。",
      "A quieter steel-toned accent for dense operational workspaces.",
    ),
    accent: "#5d708d",
  ...
  },
  {
    ...
    description: lt(
      "更温暖的动作强调色，适合审计、告警和响应流程。",
      "更溫暖的動作強調色，適合稽核、告警和回應流程。",
      "Warmer action emphasis for audits, alerts, and response workflows.",
    ),
    accent: "#d48c00",
