...
@TableName("meet_guest_request")
public class MeetGuestRequest {

    @TableId(type = IdType.ASSIGN_ID)
    private Long id;
    private Long roomId;
    private Long ownerId;
    private String joinCodeSnapshot;
    ...
    public String getJoinCodeSnapshot() {
        return joinCodeSnapshot;
    }

    public void setJoinCodeSnapshot(String joinCodeSnapshot) {
        this.joinCodeSnapshot = joinCodeSnapshot;
    }
