...
7. 如修改商业化、支持承诺、可观测目标或企业准入文案，先对齐 `docs/commercial/pricing-boundaries.md`、`docs/commercial/support-policy.md` 与 `docs/observability/sli-slo.md`。
8. 如把 v2.2 外部证据项从 partial / pending 改为 done，必须先提供 `docs/v22-external-evidence-checklist.md` 要求的真实证据，并记录 `bash scripts/validate-v22-external-evidence.sh` 的结果。
