...
- [x] `docs/release/community-v1-v1.6-final-signoff.md` 已签收

## 正式发布动作
1. [x] 在 `dev/v1.6` 上完成定向前端回归。
2. [x] 在 `dev/v1.6` 上完成 `validate-local` 门禁。
3. [x] 提交 `v1.6` 最终代码与文档。
4. [x] 准备 `v1.6.0` annotated tag。
5. [x] 将 `dev/v1.6` 合并到 `main`。
6. [x] 在 `main` 上复核 `README / release notes / support boundaries / module maturity / install / runbook / self-hosted pages`。
7. [ ] 推送 `dev/v1.6`、`main` 与 `v1.6.0` 到远端（若远端可写）。
8. [x] 回填本文件中的正式发布策略与 release 引用信息。
