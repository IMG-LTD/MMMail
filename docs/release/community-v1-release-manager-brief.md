...
## 当前状态
- 正式状态：`GA_RELEASED`
- 含义：`v1.0.0` 已正式发布；tag = `v1.0.0`，commit = `829c60b`，发布 workflow = `23799189119`
- `v1.0` 当前维护线：`release/v1.0`
...
## 分支职责
- `release/v1.0`：`v1.0.x` 维护线，只承接 release-blocking / 安全修复 / 最小文档勘误
...
- `release/v1.0` 上的 `v1.0.x` 文档勘误与 release metadata 纠偏
- 自托管反馈分流
