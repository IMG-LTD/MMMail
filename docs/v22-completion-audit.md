...
| Command | Result |
|---|---|
| `node --test tests/v22-ci-toolchain-contract.test.mjs tests/v22-repository-governance-contract.test.mjs tests/v22-repository-governance-validation-contract.test.mjs` | 29 passed after pass-83 API-generation and frontend env governance updates |
