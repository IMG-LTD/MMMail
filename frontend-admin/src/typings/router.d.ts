...
declare module 'vue-router' {
  interface RouteMeta {
     ...
     */
    roles?: string[];
    /** Single role required for the route */
    role?: string;
    /** Required entitlements for the route */
    requires?: string[];
    /** One of these entitlements is required for the route */
    anyOf?: string[];
    /** Feature flag required for the route */
    featureFlag?: string;
    /** Whether the route requires an organization scope */
    orgRequired?: boolean;
    /** Whether the route is backed by a paid product gate */
    premiumOnly?: boolean;
    /** Access fallback rendered by EntitlementGate */
