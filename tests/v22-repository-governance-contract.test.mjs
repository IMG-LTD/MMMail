...
test('v2.2 completion audit maps the objective to concrete evidence and external gaps', async () => {
  ...
  assert.match(audit, /25977701508[\s\S]*25977702756[\s\S]*rc10 provides a main-repo remote release evidence baseline/);
  ...
  for (const required of [
    ...
    /rc10 `MMMail Images` success is historical baseline evidence only/,
