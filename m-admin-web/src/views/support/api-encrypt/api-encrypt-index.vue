...
- 后端请看：@ApiEncrypt 和 @ApiDecrypt 注解，具体请看 sa-common项目中的 com.mmmail.common.module.support.apiencrypt 包
- demo请看：前端：/views/support/api-encrypt 目录，后端 请看：m-admin项目的：com.mmmail.admin.module.system.support.AdminApiEncryptController
</pre
      >
    </template>
  </a-alert>
